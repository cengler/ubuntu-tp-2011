...
\resumen{Realizar ingenier\'ia reversa sobre el programa compilado whoop y explicar
en lenguaje de alto nivel lo que hace y como los hace.
tambi\'en desarrollar el programa upcase en C que ejecute el comando pasado por
par\'ametro, pero haciendo que toda la salida estandar del programa aparezca en
may\'usculas.}
...
\footspace{1cm}
\integrante{Dominguez, Pablo
Sebastian}{108/05}{pablo.sebastian.dominguez@gmail.com}
