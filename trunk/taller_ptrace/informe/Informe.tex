...
\resumen{Realizar ingenier reversa cobre el programa compilado whoop y explicar
en lenguaje de alto nivel lo que hace y como los hace.
tambien desarrollar el programa upcase en C que ejecute el comando pasado por
parametro, pero haciendo que toda la salida estandar del programa aparezca en
mayusculas.}
