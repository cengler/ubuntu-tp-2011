...
\newcommand{\ts}{\textcolor{green}{TS}}
\newcommand{\nts}{\textcolor{red}{NTS}}
\newcommand{\tmutex}{\textcolor{blue}{tablero\_mutex}}
...
\resumen{El objetivo de este trabajo pr\'atico es implementar una versi\'on del algoritmo de Ricart y Agrawala para la coordinaci\'on de acceso a una secci\'on cr\'itica}
\keys{concurrent programming, critical section, distributed algorithm, mutual exclusion, network, synchronization}
\titulo{Tp3: MPI}
